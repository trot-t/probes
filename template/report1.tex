...
\Title{ЭТУ 849104.01 Э3 Иванов Петр Семёнович \textemdash\thisyear}
...
\ESKDsignature{ЭТУ 849121.01 Э3} % Шифр
...
\begin{circuitikz}[american voltage source]
	...
	to[american voltage source, l_=$V_2$]  ++(0,-2) node[tground] {}          % инвертирующий вход

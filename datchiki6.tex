...
\Title{Датчики. Лабораторная работа №6\textemdash\thisyear}
...
\section{Датчики для системы управления ТАД}
...
Рассчитать и смоделировать в tina схему измерения температуры, постоянного напряжения и силы тока фаз инвертора в силовой цепи тягового aсинхронного двигателя трамвая. 
